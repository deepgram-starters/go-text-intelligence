...
Go demo app for Deepgram Text Intelligence.
...
```
feat(go-text-intelligence): add diarization support
fix(go-text-intelligence): resolve WebSocket close handling
refactor(go-text-intelligence): simplify session endpoint
